...
public class Handler implements RequestHandler<Map<String, String>, ApiGatewayResponse> {
	...
	public ApiGatewayResponse handleRequest(Map<String, String> input, Context context) {
		...
		try {
			...
			Map<String, List<String>> inputBody = gson.fromJson(input.get("body"), mapType);
